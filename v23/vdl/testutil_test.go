...
type (
	...
	NSliceString     []string
	// Sets
	NSetInterface  map[NInterface]struct{} //nolint:unused
	NSetTypeObject map[*Type]struct{}      //nolint:unused
	...
	// Maps
	NMapInterface  map[NInterface]NInterface //nolint:unused
	NMapTypeObject map[*Type]*Type           //nolint:unused
	...
	NStructXYZBoolUnexported struct{ a, X, b, Y, c, Z, d NBool } //nolint:unused
	...
	NStructVWXMixed   struct {
		...
		a bool //nolint:unused
		V int64
		b string //nolint:unused
		W float64
		X float32
		c []byte      //nolint:unused
		d interface{} //nolint:unused
	}
