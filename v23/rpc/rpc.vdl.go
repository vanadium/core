...
func initializeVDL() struct{} {
	...
	vdlTypeStruct1 = vdl.TypeOf((*Request)(nil)).Elem()
	vdlTypeStruct2 = vdl.TypeOf((*vdltime.WireDeadline)(nil)).Elem()
	vdlTypeStruct3 = vdl.TypeOf((*security.WireBlessings)(nil)).Elem()
